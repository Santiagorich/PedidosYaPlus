...
// @run-at       document-end
// @match        https://www.pedidosya.com.uy/restaurantes*
// @include      *://www.pedidosya.com.ar/restaurantes*
// @include      *://www.pedidosya.com.bo/restaurantes*
// @include      *://www.pedidosya.cl/restaurantes*
// @include      *://www.pedidosya.cr/restaurantes*
// @include      *://www.pedidosya.com.ec/restaurantes*
// @include      *://www.pedidosyasv.com.sv/restaurantes*
// @include      *://www.pedidosya.com.gt/restaurantes*
// @include      *://www.pedidosya.com.hn/restaurantes*
// @include      *://www.pedidosyani.com.ni/restaurantes*
// @include      *://www.pedidosya.com.pa/restaurantes*
// @include      *://www.pedidosya.com.py/restaurantes*
// @include      *://www.pedidosya.com.pe/restaurantes*
// @include      *://www.pedidosya.com.do/restaurantes*
// @include      *://www.pedidosya.com.uy/restaurantes*
// @include      *://www.pedidosya.com.ve/restaurantes*
// @icon         https://www.google.com/s2/favicons?domain=pedidosya.com.uy
// @grant        none
// ==/UserScript==
...
function waitForElementToDisplay(selector, checkFrequencyInMs){
...
rightcont.appendChild(loadingcounter)
elperscroll = 50
...
elnumber = 0
await getMenus()
document.querySelector('#results__right__component').innerHTML = ''
...
var shopresultclone = document.querySelector('#shop_card_result').cloneNode(true)
...
var elpic = shopresultclone.querySelector('picture').parentElement
...
async function getMenus() {
    ...
    for (const [idx, element] of restaurantsjson.list.data.entries()) {
        ...
        if (idx % 50 == 0 && idx != 0 && restaurantsjson.list.data.length > 100) {
...
async function showFood() {
    countertext.innerText = 0 + ' comidas encontradas'
    var counter = 0;
    var fragment = '';
